...
<head>
    ...
    <?php 
    $base_url = "http://localhost:82/santeplus/";
...
<body class="bg-gradient-success bg-success">
                                ...
                                <div class="p-5">
                                    ...
                                    <div class="col-md-12">
                                    	<div class="container text-center">
											...
											<hr>
											<a class="btn btn-success btn-block" href="javascript:history.go(-1);">Revenir en arrière</a>
										</div>
                                    </div>
