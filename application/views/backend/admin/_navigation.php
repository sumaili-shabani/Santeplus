            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <div class="dropdown-divider"></div>
                        <h6 class="collapse-header">Publicité:</h6>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo(base_url()) ?>admin/info_personnel">Informations  personneles</a>
                        ...
                        <ul class="nav-list">
                            <li class="nav-item">
                                ...
                                <ul class="nk-menu-sub">
                                    ...
                                    <li class="nk-menu-item text-muted">
                                        <a href="<?php echo(base_url()) ?>admin/video" class="nk-menu-link text-muted" data-original-title="Nos vidéos" title="">
                                            <span class="nk-menu-text"><i class="fa fa-video-camera"></i> Nos vidéos</span>
                                        </a>
                                    </li>

                                    <li class="nk-menu-item text-muted">
                                        <a href="<?php echo(base_url()) ?>admin/galery" class="nk-menu-link text-muted" data-original-title="Notre galerie" title="">
                                            <span class="nk-menu-text"><i class="fa fa-picture-o"></i> Notre galerie</span>
                                        </a>
                                    </li>

                                    <li class="nk-menu-item text-muted">
                                        <a href="<?php echo(base_url()) ?>admin/rapport" class="nk-menu-link text-muted" data-original-title="Notre galerie" title="">
                                            <span class="nk-menu-text"><i class="fa fa-file"></i> Les rapports</span>
                                        </a>
                                    </li>
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="collapse-item" href="<?php echo(base_url()) ?>admin/info_service">Info sur nos services</a>
