                  ...
                  <div class="table-responsive">
                      <table id="user_data2" class="table-striped  nk-tb-list nk-tb-ulist dataTable no-footer" data-auto-responsive="false" role="grid" aria-describedby="DataTables_Table_1_info">
                          <thead class="tb-member-head thead-light">  
                              <tr>
                                  <th width="5%">
                                    <button type="button" name="delete_all" id="delete_all" class="btn btn-hub btn-sm"><i class="fa fa-plus"></i> &nbsp;Add</button>
                                  </th> 
                         ...
                         <tfoot>  
                              <tr>  
                                  <th width="5%">
                                    <button type="button" name="delete_all2" id="delete_all2" class="btn btn-hub btn-sm"><i class="fa fa-plus"></i> &nbsp;Add</button>
                                  </th> 
                                  <th width="5%">Avatar</th>
                                  <th width="20%">Nom de la vidéo</th>  
                                  <th width="20%">Description </th> 
