    ...
    <section id="feature_category_section" class="feature_category_section section_wrapper">
		<div class="container">   
			<div class="row">
				<!-- contenu principal -->
			   	<div class="col-md-9">
			   		<?php include('component/_categorie.php') ?>
			   	</div><!--col-md-9-->
...
<script type="text/javascript">
    $(document).ready(function(){
      ...
      $('#prefetch_info .typeahead_info').typeahead(null, {
       name: 'sample_data',
       display: 'name',
       source:sample_data,
       limit:10,
       templates:{
        suggestion:Handlebars.compile('<div class="col-md-12 card"><div class="row card-body"><div class="col-md-2" style="padding-right:5px; padding-left:5px;"><img src="<?php echo(base_url()) ?>upload/article/{{image}}" class="img-thumbnail" width="68" /></div><div class="col-md-10" style="padding-right:5px; padding-left:5px;"><a class="text-primary" href="<?php echo(base_url()) ?>home/article/{{idart}}">{{name}}</a><hr></div></div></div>')
       }
      });
    });
</script>
