<div class="fbt-vc-inner nude large clearfix" style="margin-top: 10px;">
	<div class="title-wrapper border-5">
		<h2><span class="color-5"><?php echo($title) ?></span></h2>
			        ...
			        <div class="post-item small">
						<div class="row">
							...
							<div class="col-md-7 padding-left-5">
								...
								<span>-</span>
								<span> <i class="fa fa-eye mr-1"></i> <?php echo($nombre_vue) ?> vue(s)</span>
									</div>
									<div class="text-content">
										<div class="col-md-12"><a href="<?php echo(base_url())?>home/article/<?php echo($row['idart'])?>" class="btn btn-info"><i class="fa fa-plus mr-1"></i> Lire la publication</a></div>
									</div>
								</div>
							</div>
						</div>
