										...
										<div class="col-md-6 col-sm-4 big-section no-padding">
											<div class="post-item clearfix">
												<div class="img-thumb">
													...
													<a href="javascript:void(0);"><div class="fbt-resize" style="background-image: url('<?php echo(base_url()) ?>upload/annumation/logo1.JPG')"></div></a>
													<div class="img-credits">
										...
										<div class="col-md-3 col-sm-4 no-padding">
											<div class="post-item clearfix">
												<div class="img-thumb">
													...
													<a href="javascript:void(0);"><div class="fbt-resize" style="background-image: url('<?php echo(base_url()) ?>upload/annumation/logo2.jpg')"></div></a>
													<div class="img-credits">
